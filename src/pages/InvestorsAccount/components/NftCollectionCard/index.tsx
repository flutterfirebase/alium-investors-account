    ...
    <NftCollectionCardWrap >
      ...
      <FieldCards ref={fieldCards} maxWidth="unset">
        ...
        </TotalCards>
        {
          multiRows
          ? <>
              <CardRow pool={pool} selectedCard={selectedCard} onSelectCard={onSelectCard} cards={cards.slice(0, cards.length / 2)}/>
              <CardRow pool={pool} selectedCard={selectedCard} onSelectCard={onSelectCard} cards={cards.slice(cards.length / 2)}/>
          </>
