...
export const NFT_ALIUM_ARCHIVEMENT_COLLECTIBLE: any = process.env.REACT_APP_NFT_ALIUM_ARCHIVEMENT_COLLECTIBLE;
export const NFT_ALIUM_COLLECTIBLE_NFT: any = process.env.REACT_APP_NFT_ALIUM_COLLECTIBLE_NFT
export const NFT_ALIUM_CHASHBOX: any = process.env.REACT_APP_NFT_ALIUM_CHASHBOX;

export const NFT_EXCHANGER_PRIVATE: any = process.env.REACT_APP_NFT_EXCHANGER_PRIVATE;
